...
function remakePcIam(){
  ...
  functionObj.bgiStyle(iAmImg,'./module/image/Iam_illust1.png', 'center', 'cover', 0.8);
  move(iAmImg, '40%', '41%');
  ...
  for(let i = 0; i<rightContents.length; i++){
    functionObj.container(rightContents[i], '95%', '45%', 'row');
  ...
  functionObj.bgiStyle(iDid[1],'./module/image/Iam_illust3.png', 'center', 'cover', 0.8);
  move(iDid[1], '65%', '66%');
