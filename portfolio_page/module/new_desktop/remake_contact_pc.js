...
function remakeContact(){
  ...
  container[0].innerHTML = innerHTMLContact(contactText, './module/image/mail.png', './module/image/mobile.png');
  ...
  for(let i = 0; i<imgArr.length; i++){
    if(imgArr[i].dataset.img === '1'){
      ...
      functionObj.position(imgArr[i], 'absolute', '11%', '7%');
  ...
  functionObj.position(leftContents[1].children[3].children[1], 'absolute', '15%', '80%');
  functionObj.bgiStyle(leftContents[1].children[3].children[1],'./module/image/contact_img.png','center','contain',0.9);
  ...
  functionObj.borderRound(leftContents[2].children[1], '15%', '30%', '30px', colorArr[5]);
  ...
  functionObj.boxStyle(leftContents[2].children[2], '150px', '200px', colorArr[0], '40%');
  functionObj.position(leftContents[2].children[2], 'absolute', '60%', '-150%');
  functionObj.bgiStyle(leftContents[2].children[2], './module/image/me.png', 'center', 'cover', 0.8);
