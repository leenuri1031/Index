...
export function project2PageMaker() {
  if (
    ...
    functionObj.container(sections[0].children[1], "95%", "65%", "row");
    ...
    functionObj.iAmPageTextBox(textContent, "95%", "90%");
    ...
    functionObj.container(sections[2].children[1], "100%", "70%", "row");
